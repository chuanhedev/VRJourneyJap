...
public class VitoVRSelectionRadial : MonoBehaviour
{
    ...
    [SerializeField]
    private VitoVRInput m_VRInput;                                         // Reference to the VRInput so that input events can be subscribed to.
