...
public class VitoVRReticleStatic : MonoBehaviour
{
    [SerializeField]
    ...
    public void SetPosition()
    {
        ...
        if (effectEX)
        {
            m_ReticleTransform.localScale = Vector3.Slerp(m_ReticleTransform.localScale, m_OriginalScale * m_DefaultDistance, Time.unscaledDeltaTime * effectSpeed);
        }
        else
        {
    ...
    public void SetPosition(RaycastHit hit)
    {
        ...
        if (effectEX)
        {
            m_ReticleTransform.localScale = Vector3.Slerp(m_ReticleTransform.localScale, m_OriginalScale * hit.distance * 3, Time.unscaledDeltaTime * effectSpeed);
        }
        else
        {
